		...
		<form class="form-horizontal">
			...
			<div class="form-horizontal">
				<div class="form-group">
					<div class="radio">
						<label class="text-center" id="optionsRadios" >
							<input type="radio" name="optionsRadios" class="col-sm-offset-3"
								id="optionsRadios" value="option2">이용약관, 개인정보 수집 및 이용에
							모두 동의합니다.
						</label>
					</div>
				</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-2">
					<button type="button"
						class="btn btn-success col-sm-offset-3 btn-lg"
						onclick="location.href='Join.jsp'">동의</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="btn btn-default btn-lg"
						onclick="location.href='Login.jsp'">동의 안함</button>
