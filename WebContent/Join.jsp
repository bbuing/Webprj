...
<body>
	<div class="container">
		<form class="form-horizontal">
			...
			<div class="form-group">
				<label for="Joinnickname" class="col-sm-3 control-label">별명 </label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="Joinnickname" placeholder="별명" />
				</div>
				<div class="col-sm-1">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="Joinemail" placeholder="이메일"/>
				</div>
				<div class="col-sm-2">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="Joinpw" placeholder="영문과 숫자 조합 8자리 이상 입력하세요."/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="Joinpw2" placeholder="비밀번호 확인" />
				</div>
			</div>

			<div class="form-group">
				<label for="Joinquestion" class="col-sm-3 control-label">질문 </label>
				<div class="col-sm-6">
					<select class="form-control">
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-6">
					<input type="text" class="form-control" id="Joinquestion" placeholder="질문의 답을 입력하세요." />
				</div>
			</div>

			<div class="form-group">
				<label for="Joinphone" class="col-sm-3 control-label">핸드폰 번호 </label>
				<div class="col-sm-2">
					<select class="form-control">
			...
			<div class="form-group">
				<label for="Joininterest" class="col-sm-3 control-label">관심 여행</label>
				<label class="checkbox-inline">&nbsp;&nbsp;&nbsp;
				<input type="checkbox" id="inlineCheckbox1" value="option1" /> 커플 여행
				</label> 
				<label class="checkbox-inline"> 
				<input type="checkbox" id="inlineCheckbox2" value="option2"/> 가족 여행
				</label> <label class="checkbox-inline"> 
				<input type="checkbox" id="inlineCheckbox3" value="option3"/> 나홀로 여행
				</label> <label class="checkbox-inline"> 
				<input type="checkbox" id="inlineCheckbox3" value="option4"/> 기차 여행
				</label> <label class="checkbox-inline"> 
				<input type="checkbox" id="inlineCheckbox3" value="option5"/> 무전 여행
				</label>
			</div>
			<hr/>
			<div class="form-group">
